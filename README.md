...
## **Aim**
Fine tune [Phi-4-mini-instruct](https://huggingface.co/microsoft/Phi-4-mini-instruct) model using LoRA on the consolidated [African History Dataset](https://huggingface.co/datasets/DannyAI/African-History-QA-Dataset)
...
- Runpod jupyter notebook lacks the intellisense of Colab and VsCode which led to slow development of the project as I was unable to connect the Runpod instance to VsCode remotely via SSH protocol.
