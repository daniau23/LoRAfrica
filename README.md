...
## **Aim**
Fine tune Phi-4-mini-instruct model using LoRA on the consolidated data about African History using the QA dataset from [African History Dataset](DannyAI/African-History-QA-Dataset)
